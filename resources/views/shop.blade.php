...
<div class="container mt-5 mb-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4" style="height: 440px">
                ...
                <div class="card-body">
                    ...
                    @if(Auth::check())
                        <button class="btn btn-dark w-100 add-to-cart" data-product-id="{{ $product->id }}">Add to Cart</button>
                    @else
                        <button class="btn btn-dark w-100" onclick="showLoginModal()">Add to Cart</button>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Lanjut Belanja</button>
                <a href="{{ route('cart.view') }}" class="btn btn-success">Lihat Keranjang</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You must log in first before adding products to your cart.</p>
                <a href="{{ route('login') }}" class="btn btn-primary w-100">Login Now</a>
            </div>
        </div>
    </div>
</div>
